...
INSTALLED_APPS = [
    ...
    'financial_data',  # Your app
    'accounts',        # If you have a separate accounts app
]
...
STATICFILES_DIRS = [BASE_DIR / 'static']  # Add this for development
...
SESSION_COOKIE_SECURE = False  # Ensure secure cookies are off in development
